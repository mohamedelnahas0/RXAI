...
namespace RXAI.Migrations
{
    ...
    [Migration("20250301041402_compositkeyActive")]
    partial class compositkeyActive
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RXAI.Entities.Prescription", b =>
                {
                    ...
                    b.HasIndex("DrugBankID", "Strength");
            ...
            modelBuilder.Entity("RXAI.Entities.Prescription", b =>
                {
                    ...
                    b.HasOne("RXAI.Entities.ActiveIngredient", "ActiveIngredient")
                        .WithMany("Prescriptions")
                        .HasForeignKey("DrugBankID", "Strength")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
