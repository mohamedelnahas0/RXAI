...
namespace RXAI.Migrations
{
    ...
    [Migration("20250301050148_compositkeyActiALl")]
    partial class compositkeyActiALl
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RXAI.Entities.ActiveIngredient", b =>
                {
                    ...
                    b.HasKey("DrugBankID", "IngredientName", "Strength", "StrengthUnit");
            ...
            modelBuilder.Entity("RXAI.Entities.Prescription", b =>
                {
                    ...
                    b.HasIndex("DrugBankID", "IngredientName", "Strength", "StrengthUnit");
            ...
            modelBuilder.Entity("RXAI.Entities.Prescription", b =>
                {
                    ...
                    b.HasOne("RXAI.Entities.ActiveIngredient", "ActiveIngredient")
                        .WithMany("Prescriptions")
                        .HasForeignKey("DrugBankID", "IngredientName", "Strength", "StrengthUnit")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
